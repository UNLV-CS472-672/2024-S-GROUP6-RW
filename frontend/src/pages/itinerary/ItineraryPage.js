   ...
   <div>
     <div className="itinerary-banner">
       <div className="itin-title-date-btn">
         <Typography className="itinerary-title">Itinerary for: Las Vegas</Typography>
         <Typography className="itin-dates"> 04/24/2024 - 04/30/2024 </Typography>
         <div className="create-event-btn-div">
           <button className="create-event-btn" onClick={handleCreateEventBtnClick}>
