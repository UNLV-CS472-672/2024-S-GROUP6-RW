...
const NewExpenseDialog = ({ newData, expense, onAddExpense }) => {
	...
	const handleAdd = () => {
		...
		// call the onAddExpense function with the new expense details
		onAddExpense({
			// if expense is not null then we will use the id of the expense
			// if expense is null then we will use the random id
